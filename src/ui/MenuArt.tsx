  ...
  return (
    <g transform={`translate(${x} 0)`}>
      ...
      {[-16, -5.5, 5.5, 16].map((lx) => (
        <circle key={lx} cx={lx} cy={36} r="4.4" fill="#eef6ff" className="lamp" />
      ))}
    ...
    <svg className="hero-pitch" viewBox="0 0 800 330" preserveAspectRatio="xMidYMid slice"
      ...
      <defs>
        ...
        <linearGradient id="beam" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#eef6ff" stopOpacity="0.20" />
        ...
        <pattern id="crowd" width="14" height="10" patternUnits="userSpaceOnUse">
          ...
          <circle cx="10" cy="3" r="1.5" fill="#43d99a" opacity="0.22" />
          <circle cx="3" cy="8" r="1.5" fill="#e5cd7c" opacity="0.18" />
        </pattern>
