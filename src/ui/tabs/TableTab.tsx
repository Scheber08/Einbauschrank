                  ...
                  return (
                    <tr key={row.clubId} className={isUser ? 'user' : promo ? 'highlight' : ''}>
                      <td className="mono" style={{
                        borderLeft: `3px solid ${promo ? '#43d99a' : releg ? '#e2697a'
                          : playoff ? '#5fb2e8' : 'transparent'}`,
                      }}>{pos}</td>
                      <td>
      ...
      {view === 'table' && (
        <>
              ...
              <table>
                ...
                <tbody>
                  {table.map((row, i) => {
                    ...
                    const border = pos <= 8 ? '#43d99a' : pos <= 16 ? '#5fb2e8' : '#e2697a';
                    return (
          ...
          <p className="tiny dim" style={{ marginTop: '0.5rem', marginBottom: 0 }}>
            {t('table.championsHint', { n: cc.clubIds.length })}
          </p>
        </>
      )}
